...
function ScrollStrip({
  ...
  return (
    ...
    >
      <div
        className={`py-3 sm:py-4 ${isPrimary ? "bg-[#8B8B3E]" : "bg-gray-200"}`}
      >
        <div
          ref={innerRef}
  ...
  return (
    ...
    >
      ...
      >
        <a
          href="/designers"
          className="inline-flex items-center gap-2 bg-[#8B8B3E] hover:bg-[#747430] text-white text-[11px] tracking-[.2em] uppercase font-bold px-8 py-3.5 rounded-sm transition-colors"
        >
          Meet All Designers
